$(document).ready(() => {
  ...
  $.getJSON("https://ipinfo.io/json?token=527fdee7d62268", onLocationGot);
  ...
  function updateWeatherCurrently(
    infoCurrently,
    $temp,
    $summary,
    $humidity,
  ...
  function switchTemperatureUnitNext7d() {
    let minTemp = $next7dTemp.attr("min"),
      maxTemp = $next7dTemp.attr("max");
    let newMin, newMax;
